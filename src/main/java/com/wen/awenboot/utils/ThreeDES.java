...
//    private static String secretKey = "b2t3MlhlU3FkTWxmcXZpMGwySkNkcEVq";


    public static void main(String[] args) throws Exception {
//        String str = "B4Sb4b8F/E9qwVhIx4D7uZGukoRfaA7Foq0RykEISJ5tdjw32LgfsmYg8BtCUt8PD1D1EXY5RC7E\n+5ci5qd5yleRmGp5bbKokiiJIFR85u0pmLxpdr98bw==";
//        String s = decrypt(str, secretKey, "PKCS5", "", "ECB");
//        System.out.println(s);

        String str = "B4Sb4b8F/E9qwVhIx4D7uS9jlsWRAyzQLaBwZkzQviltdjw32Lgfsju3CMPKGYpJV0MAW/Lnx3Mp\nmLxpdr98bw==";
        String s = decrypt(str);
        System.out.println(s);

//        String str1 = "5/0wSQqMVpqChf7TJW/q7+uI4Kz7zV10";
//        String s1 = decrypt(str1, secretKey, "PKCS5", "", "ECB");
//        System.out.println(s1);

        String str1 = "5/OwSQqMVpqChf7TJW/q7+uI4Kz7rV1O";
        String s1 = decrypt(str1);
        System.out.println(s1);
    }

    public static String decrypt(String str1) throws Exception {
        return decrypt(str1, secretKey, "PKCS5", "", "ECB");
    }
