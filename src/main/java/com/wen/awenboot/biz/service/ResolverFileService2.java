...
@Slf4j
@Getter
public class ResolverFileService2 {
    ...
    public ResolverFileService2(ZhuangkuConfig cfg, String dsFileName, String prefix) {
        this.cfg = cfg;
        String fName = dsFileName;
        ...
        exportFile = new File(cfg.getExportDir() + "ret_" + tmp + fName);
    ...
    public ResolverFileService2(ZhuangkuConfig cfg, String dsFileName) {
        this(cfg, dsFileName, null);
    }
