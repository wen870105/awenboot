...
public class WechatController {
    ...
    public Object detail(@RequestBody DetailRequest query) {
        ...
        Result codeRet = Result.success(detailResponse);
...
//        Result codeRet = Result.success(detail);
    ...
    public Object list(ListRequest request) {
        ...
        final Page<BizBlog> pager = blogService.selectPage(query);
        List<DetailResponse> list = blogConverter.blogList2Detail(pager.getResult());
//
//        DetailResponse detail = new DetailResponse();
